...
const AllProductsPage = () => {
    ...
    const categories = Object.keys(productsByCategory).filter(category => {
        if (!searchQuery) return true;
        const products = productsByCategory[category];
        // Check if any product matches or category matches
        const hasMatchingProducts = products.some(p =>
            p.productName.toLowerCase().includes(searchQuery) ||
            (p.description && p.description.toLowerCase().includes(searchQuery))
        );
        return hasMatchingProducts || category.toLowerCase().includes(searchQuery);
    });
    ...
    return (
        <div className="container" style={{ padding: '2rem' }}>
            <div style={{ marginBottom: '2rem' }}>
                <h1 style={{ margin: '0 0 0.5rem' }}>All Products</h1>
                <p style={{ color: '#666', margin: 0 }}>Browse products by category</p>
            </div>
                ...
                return (
                    <div key={categoryName} style={{ marginBottom: '3rem' }}>
                        ...
                        <div style={{
                            ...
                            <h2 style={{ margin: 0, color: 'var(--primary)' }}>{categoryName}</h2>
